...
public class SampleCompleteGraph
{
   public AdjacencyListGraph<Point2D.Double, Double> g;

   public SampleCompleteGraph ( )
   {
        ...
        // make a complete graph, with an edge between every pair of vertices
        // the edge weight is the Euclidean distance between the vertices.
