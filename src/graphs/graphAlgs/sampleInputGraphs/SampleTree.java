...
public class SampleTree
{
   ...
   public SampleTree ( )
   {
        ...
        vArray[ 2 ] = g.insertVertex ( new Point2D.Double ( 0.5396736931666348, 0.8002502133850073 ) );
        ...
        addEdge ( vArray[1], vArray[12] );         
        addEdge ( vArray[1], vArray[24] );
        addEdge ( vArray[10], vArray[24] );
        addEdge ( vArray[10], vArray[11] );
        addEdge ( vArray[11], vArray[13] );            
        addEdge ( vArray[13], vArray[7] );    
        addEdge ( vArray[7], vArray[5] );  
        addEdge ( vArray[5], vArray[4] );
        addEdge ( vArray[5], vArray[6] ); 
        addEdge ( vArray[6], vArray[8] );  
        addEdge ( vArray[8], vArray[9] );         
        addEdge ( vArray[9], vArray[17] );   
        addEdge ( vArray[8], vArray[16] );
        addEdge ( vArray[16], vArray[25] ); 
        addEdge ( vArray[25], vArray[3] );  
        addEdge ( vArray[3], vArray[0] ); 
        addEdge ( vArray[0], vArray[2] );   
        addEdge ( vArray[0], vArray[23] );
        addEdge ( vArray[23], vArray[18] ); 
        addEdge ( vArray[18], vArray[14] );  
        addEdge ( vArray[14], vArray[15] );    
        addEdge ( vArray[14], vArray[20] );      
        addEdge ( vArray[18], vArray[19] );
        addEdge ( vArray[19], vArray[22] ); 
        addEdge ( vArray[22], vArray[21] );   
   }
